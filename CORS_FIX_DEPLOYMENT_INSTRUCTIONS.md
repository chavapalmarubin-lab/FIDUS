...
**Problem:**
- Frontend `.env` currently points to: `https://fidus-agents.preview.emergentagent.com`
...
5. Current value: `https://fidus-agents.preview.emergentagent.com` ❌
...
- ❌ Frontend calling: `https://fidus-agents.preview.emergentagent.com`
