...
**Problem:**
- Frontend `.env` currently points to: `https://viking-analytics.preview.emergentagent.com`
...
5. Current value: `https://viking-analytics.preview.emergentagent.com` ❌
...
- ❌ Frontend calling: `https://viking-analytics.preview.emergentagent.com`
