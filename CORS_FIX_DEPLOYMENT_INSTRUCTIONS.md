...
**Problem:**
- Frontend `.env` currently points to: `https://fund-manager-assign.preview.emergentagent.com`
...
5. Current value: `https://fund-manager-assign.preview.emergentagent.com` ❌
...
- ❌ Frontend calling: `https://fund-manager-assign.preview.emergentagent.com`
