...
**Problem:**
- Frontend `.env` currently points to: `https://viking-trade-dash.preview.emergentagent.com`
...
5. Current value: `https://viking-trade-dash.preview.emergentagent.com` ❌
...
- ❌ Frontend calling: `https://viking-trade-dash.preview.emergentagent.com`
