...
**Problem:**
- Frontend `.env` currently points to: `https://vkng-dashboard.preview.emergentagent.com`
...
5. Current value: `https://vkng-dashboard.preview.emergentagent.com` ❌
...
- ❌ Frontend calling: `https://vkng-dashboard.preview.emergentagent.com`
