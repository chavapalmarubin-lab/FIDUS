...
**Problem:**
- Frontend `.env` currently points to: `https://fidus-restore.preview.emergentagent.com`
...
5. Current value: `https://fidus-restore.preview.emergentagent.com` ❌
...
- ❌ Frontend calling: `https://fidus-restore.preview.emergentagent.com`
