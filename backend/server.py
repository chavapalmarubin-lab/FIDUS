...
MOCK_USERS = {
    "admin": {
        ...
        "status": "active",
        "profile_picture": "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&h=150&fit=crop&crop=face",
        "created_at": "2025-09-26T15:42:52.758000",
        "notes": "Default admin account",
        "temp_password": "",
    ...
    "alejandro_mariscal": {
        ...
        "status": "active",
        "profile_picture": "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
        "created_at": "2025-09-26T15:44:11.683000",
        "notes": "Corrected user data - production ready",
        "temp_password": "TempPass123!",
        "must_change_password": True,
    },
}  # RESTORED - Emergency fix for production
...
async def get_google_login_url():
    ...
    try:
        ...
        frontend_url = os.environ.get('FRONTEND_URL', 'https://mockdb-cleanup.preview.emergentagent.com')
...
async def send_document_notification(document_id: str, request: Request, current_user: dict = Depends(get_current_admin_user)):
    ...
    try:
        ...
        result = await google_apis_service.send_gmail_message(
            ...
            {data.get('signing_url', 'https://mockdb-cleanup.preview.emergentagent.com/documents/sign')}
            ...
            <body>
                ...
                <p><a href="{data.get('signing_url', 'https://mockdb-cleanup.preview.emergentagent.com/documents/sign')}" style="background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Review and Sign Document</a></p>
