...
async def send_document_for_signature(
    ...
    try:
        ...
        document_url = f"https://mt5-portal.preview.emergentagent.com/documents/{document_id}/view"
...
async def get_gmail_auth_url():
    ...
    try:
        ...
        flow = Flow.from_client_secrets_file(
            ...
            redirect_uri='https://mt5-portal.preview.emergentagent.com/api/gmail/oauth-callback'
        )
