...
async def get_google_login_url():
    ...
    try:
        ...
        frontend_url = os.environ.get('FRONTEND_URL', 'https://auth-flow-debug-2.preview.emergentagent.com')
...
async def send_document_notification(document_id: str, request: Request, current_user: dict = Depends(get_current_admin_user)):
    ...
    try:
        ...
        result = await google_apis_service.send_gmail_message(
            ...
            {data.get('signing_url', 'https://auth-flow-debug-2.preview.emergentagent.com/documents/sign')}
            ...
            <body>
                ...
                <p><a href="{data.get('signing_url', 'https://auth-flow-debug-2.preview.emergentagent.com/documents/sign')}" style="background-color: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Review and Sign Document</a></p>
