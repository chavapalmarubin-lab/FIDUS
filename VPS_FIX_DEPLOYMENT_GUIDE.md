...
1. **Check backend API**:
   ```
   curl https://viking-trade-dash-1.preview.emergentagent.com/api/system/status
   ```
   Should show services operational

2. **Check MT5 accounts endpoint**:
   ```
   curl https://viking-trade-dash-1.preview.emergentagent.com/api/mt5/admin/accounts
   ```
