...
class FidusAPITester:
    def __init__(self, base_url="https://wealth-manage-1.preview.emergentagent.com"):
            ...
            for param, description in required_params.items():
                if param in query_params:
                    ...
                    if param == 'client_id':
                        ...
                        expected_redirect = 'https://wealth-manage-1.preview.emergentagent.com/api/gmail/oauth-callback'
