...
# Authenticate
auth_response = session.post('https://investsim-1.preview.emergentagent.com/api/auth/login', json={
    'username': 'admin',
...
if auth_response.status_code == 200:
    ...
    # Test simulation
    sim_response = session.post('https://investsim-1.preview.emergentagent.com/api/investments/simulate', json={
        'investments': [
