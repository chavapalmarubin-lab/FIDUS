...
- Frontend .env: REACT_APP_BACKEND_URL=https://mt5-data-integrity.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://mt5-data-integrity.preview.emergentagent.com/api"  # From frontend .env
