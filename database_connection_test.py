...
- Frontend .env: REACT_APP_BACKEND_URL=https://multi-tenant-hub-32.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://multi-tenant-hub-32.preview.emergentagent.com/api"  # From frontend .env
