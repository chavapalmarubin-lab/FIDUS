...
- Frontend .env: REACT_APP_BACKEND_URL=https://trading-platform-110.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://trading-platform-110.preview.emergentagent.com/api"  # From frontend .env
