...
- Frontend .env: REACT_APP_BACKEND_URL=https://lucrum-api-debug.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://lucrum-api-debug.preview.emergentagent.com/api"  # From frontend .env
