...
- Frontend .env: REACT_APP_BACKEND_URL=https://truth-fincore.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://truth-fincore.preview.emergentagent.com/api"  # From frontend .env
