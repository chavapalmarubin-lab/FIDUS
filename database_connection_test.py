...
- Frontend .env: REACT_APP_BACKEND_URL=https://alloc-refresh.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://alloc-refresh.preview.emergentagent.com/api"  # From frontend .env
