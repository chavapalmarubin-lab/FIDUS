...
- Frontend .env: REACT_APP_BACKEND_URL=https://mt5-autohealing.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://mt5-autohealing.preview.emergentagent.com/api"  # From frontend .env
