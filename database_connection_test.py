...
- Frontend .env: REACT_APP_BACKEND_URL=https://fidus-google-sync.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fidus-google-sync.preview.emergentagent.com/api"  # From frontend .env
