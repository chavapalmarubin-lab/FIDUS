...
- Frontend .env: REACT_APP_BACKEND_URL=https://referral-tracker-9.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://referral-tracker-9.preview.emergentagent.com/api"  # From frontend .env
