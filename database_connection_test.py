...
- Frontend .env: REACT_APP_BACKEND_URL=https://equity-peak-tracker.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://equity-peak-tracker.preview.emergentagent.com/api"  # From frontend .env
