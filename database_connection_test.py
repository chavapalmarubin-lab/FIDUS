...
- Frontend .env: REACT_APP_BACKEND_URL=https://fund-manager-assign.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fund-manager-assign.preview.emergentagent.com/api"  # From frontend .env
