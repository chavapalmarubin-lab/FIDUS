...
- Frontend .env: REACT_APP_BACKEND_URL=https://tradehub-mt5.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://tradehub-mt5.preview.emergentagent.com/api"  # From frontend .env
