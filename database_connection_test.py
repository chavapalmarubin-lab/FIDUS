...
- Frontend .env: REACT_APP_BACKEND_URL=https://trader-hub-27.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://trader-hub-27.preview.emergentagent.com/api"  # From frontend .env
