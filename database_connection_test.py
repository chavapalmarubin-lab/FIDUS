...
- Frontend .env: REACT_APP_BACKEND_URL=https://viking-analytics.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://viking-analytics.preview.emergentagent.com/api"  # From frontend .env
