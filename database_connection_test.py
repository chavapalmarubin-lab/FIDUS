...
- Frontend .env: REACT_APP_BACKEND_URL=https://referral-tracker-8.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://referral-tracker-8.preview.emergentagent.com/api"  # From frontend .env
