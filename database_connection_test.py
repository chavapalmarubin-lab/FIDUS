...
- Frontend .env: REACT_APP_BACKEND_URL=https://tradingteam-setup.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://tradingteam-setup.preview.emergentagent.com/api"  # From frontend .env
