...
- Frontend .env: REACT_APP_BACKEND_URL=https://fidus-monitor.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fidus-monitor.preview.emergentagent.com/api"  # From frontend .env
