...
- Frontend .env: REACT_APP_BACKEND_URL=https://fidus-autofix.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fidus-autofix.preview.emergentagent.com/api"  # From frontend .env
