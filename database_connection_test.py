...
- Frontend .env: REACT_APP_BACKEND_URL=https://referral-rescue.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://referral-rescue.preview.emergentagent.com/api"  # From frontend .env
