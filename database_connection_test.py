...
- Frontend .env: REACT_APP_BACKEND_URL=https://quant-viking.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://quant-viking.preview.emergentagent.com/api"  # From frontend .env
