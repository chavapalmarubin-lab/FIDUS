...
- Frontend .env: REACT_APP_BACKEND_URL=https://fidus-trade.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fidus-trade.preview.emergentagent.com/api"  # From frontend .env
