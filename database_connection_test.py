...
- Frontend .env: REACT_APP_BACKEND_URL=https://financesyncpro.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://financesyncpro.preview.emergentagent.com/api"  # From frontend .env
