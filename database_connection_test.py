...
- Frontend .env: REACT_APP_BACKEND_URL=https://vps-bridge-fix.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://vps-bridge-fix.preview.emergentagent.com/api"  # From frontend .env
