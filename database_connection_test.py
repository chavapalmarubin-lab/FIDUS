...
- Frontend .env: REACT_APP_BACKEND_URL=https://fidus-agents.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fidus-agents.preview.emergentagent.com/api"  # From frontend .env
