...
- Frontend .env: REACT_APP_BACKEND_URL=https://cashflow-manager-35.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://cashflow-manager-35.preview.emergentagent.com/api"  # From frontend .env
