...
- Frontend .env: REACT_APP_BACKEND_URL=https://viking-trade-dash.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://viking-trade-dash.preview.emergentagent.com/api"  # From frontend .env
