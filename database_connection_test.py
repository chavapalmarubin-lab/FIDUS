...
- Frontend .env: REACT_APP_BACKEND_URL=https://invest-tracker-146.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://invest-tracker-146.preview.emergentagent.com/api"  # From frontend .env
