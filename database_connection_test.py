...
- Frontend .env: REACT_APP_BACKEND_URL=https://mt5-dashboard-2.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://mt5-dashboard-2.preview.emergentagent.com/api"  # From frontend .env
