...
- Frontend .env: REACT_APP_BACKEND_URL=https://prospect-portal.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://prospect-portal.preview.emergentagent.com/api"  # From frontend .env
