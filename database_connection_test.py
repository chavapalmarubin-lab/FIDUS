...
- Frontend .env: REACT_APP_BACKEND_URL=https://vkng-dashboard.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://vkng-dashboard.preview.emergentagent.com/api"  # From frontend .env
