...
- Frontend .env: REACT_APP_BACKEND_URL=https://fidus-integration-1.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://fidus-integration-1.preview.emergentagent.com/api"  # From frontend .env
