...
- Frontend .env: REACT_APP_BACKEND_URL=https://k8s-to-render.preview.emergentagent.com
...
FRONTEND_BACKEND_URL = "https://k8s-to-render.preview.emergentagent.com/api"  # From frontend .env
