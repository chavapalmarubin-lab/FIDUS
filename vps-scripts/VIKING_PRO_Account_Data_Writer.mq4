//+------------------------------------------------------------------+
//|                                VIKING_PRO_Account_Data_Writer.mq4 |
//|                                  Copyright 2025, VKNG AI Platform |
//|                                 PRO Strategy - Traders Trust      |
//+------------------------------------------------------------------+
...
// Global variables
string DataFilePath = "viking_account_1309411_data.json";
...
{
   Print("VIKING PRO Account Data Writer EA Stopped");
}
...
void WriteAccountData()
{
   ...
   FileWriteString(fileHandle, "  \"strategy\": \"PRO\",\n");
   FileWriteString(fileHandle, "  \"broker\": \"" + AccountCompany() + "\",\n");
   ...
   Print("PRO Data written: Balance=", DoubleToString(AccountBalance(), 2), 
