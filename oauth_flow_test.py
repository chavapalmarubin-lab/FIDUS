...
def test_google_console_configuration():
    ...
    actual_redirect_uri = "https://alloc-refresh.preview.emergentagent.com/admin/google-callback"
...
def simulate_oauth_callback_test():
    ...
    callback_url = "https://alloc-refresh.preview.emergentagent.com/admin/google-callback"
...
def generate_fix_recommendations():
    ...
    print(f"   https://alloc-refresh.preview.emergentagent.com/admin/google-callback")
    ...
    print(f"   REACT_APP_GOOGLE_REDIRECT_URI=https://alloc-refresh.preview.emergentagent.com/admin/google-callback")
...
def main():
    ...
    print(f"1. Backend sends redirect_uri: https://alloc-refresh.preview.emergentagent.com/admin/google-callback")
