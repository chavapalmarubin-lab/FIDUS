...
def test_google_console_configuration():
    ...
    actual_redirect_uri = "https://realtime-trader-4.preview.emergentagent.com/admin/google-callback"
...
def simulate_oauth_callback_test():
    ...
    callback_url = "https://realtime-trader-4.preview.emergentagent.com/admin/google-callback"
...
def generate_fix_recommendations():
    ...
    print(f"   https://realtime-trader-4.preview.emergentagent.com/admin/google-callback")
    ...
    print(f"   REACT_APP_GOOGLE_REDIRECT_URI=https://realtime-trader-4.preview.emergentagent.com/admin/google-callback")
...
def main():
    ...
    print(f"1. Backend sends redirect_uri: https://realtime-trader-4.preview.emergentagent.com/admin/google-callback")
