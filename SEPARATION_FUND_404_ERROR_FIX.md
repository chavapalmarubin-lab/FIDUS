...
**Expected URL:**
```
https://lucrum-api-debug.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://lucrum-api-debug.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
