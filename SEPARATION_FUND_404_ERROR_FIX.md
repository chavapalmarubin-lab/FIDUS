...
**Expected URL:**
```
https://viking-trade-dash.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://viking-trade-dash.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
