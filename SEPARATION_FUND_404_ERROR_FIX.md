...
**Expected URL:**
```
https://fund-manager-assign.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://fund-manager-assign.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
