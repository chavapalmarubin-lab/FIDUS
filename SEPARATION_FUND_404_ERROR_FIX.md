...
**Expected URL:**
```
https://mt5-sync.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://mt5-sync.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
