...
**Expected URL:**
```
https://dashboard-unify.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://dashboard-unify.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
