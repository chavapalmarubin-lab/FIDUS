...
**Expected URL:**
```
https://multi-tenant-hub-32.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://multi-tenant-hub-32.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
