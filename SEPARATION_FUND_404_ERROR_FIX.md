...
**Expected URL:**
```
https://referral-portal-5.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://referral-portal-5.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
