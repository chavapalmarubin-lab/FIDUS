...
**Expected URL:**
```
https://risk-engine-hub-1.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://risk-engine-hub-1.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
