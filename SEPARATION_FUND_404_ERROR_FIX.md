...
**Expected URL:**
```
https://securedash-5.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://securedash-5.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
