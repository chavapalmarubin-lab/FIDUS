...
**Expected URL:**
```
https://fidus-risk-deep.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://fidus-risk-deep.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
