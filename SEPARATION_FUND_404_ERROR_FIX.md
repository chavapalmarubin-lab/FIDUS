...
**Expected URL:**
```
https://fintech-dashboard-60.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://fintech-dashboard-60.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
