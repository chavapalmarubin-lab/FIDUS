...
**Expected URL:**
```
https://hull-risk-preview.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://hull-risk-preview.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
