...
**Expected URL:**
```
https://advisor-dash-1.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://advisor-dash-1.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
