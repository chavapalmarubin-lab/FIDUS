...
**Expected URL:**
```
https://financial-api-fix.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://financial-api-fix.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
