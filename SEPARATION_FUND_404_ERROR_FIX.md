...
**Expected URL:**
```
https://analytics-hub-248.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://analytics-hub-248.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
