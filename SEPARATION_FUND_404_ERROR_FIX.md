...
**Expected URL:**
```
https://viking-analytics.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://viking-analytics.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
