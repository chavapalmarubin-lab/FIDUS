...
**Expected URL:**
```
https://vkng-dashboard.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://vkng-dashboard.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
