...
**Expected URL:**
```
https://alloc-refresh.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://alloc-refresh.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
