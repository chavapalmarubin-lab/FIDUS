...
**Expected URL:**
```
https://viking-trade-dash-1.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://viking-trade-dash-1.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
