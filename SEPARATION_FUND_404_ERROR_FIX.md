...
**Expected URL:**
```
https://equity-peak-tracker.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://equity-peak-tracker.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
