...
**Expected URL:**
```
https://truth-fincore.preview.emergentagent.com/api/funds/SEPARATION/performance
```
...
fetch('https://truth-fincore.preview.emergentagent.com/api/funds/SEPARATION/performance', {
  headers: {
