...
login_response = requests.post(
    "https://auth-troubleshoot-14.preview.emergentagent.com/api/auth/login",
    json={
        "username": "admin", 
...
if login_response.status_code == 200:
    ...
    response = requests.post(
        "https://auth-troubleshoot-14.preview.emergentagent.com/api/mt5/admin/add-manual-account",
        json=test_account,
        headers=headers
    )
