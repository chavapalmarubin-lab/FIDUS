#!/usr/bin/env python3
"""
Update MT5 Account Balances for Alejandro
Set the 4 MT5 accounts to total exactly $118,151.41
"""
...
async def update_mt5_balances():
    """Update MT5 account balances to match production specifications"""
    ...
    try:
        print("🏦 UPDATING MT5 ACCOUNT BALANCES")
        print("=" * 50)
        ...
        for account in balance_accounts:
            account_number = account.get('mt5_account_number')
        ...
        if abs(total_balance - 118151.41) < 0.01:
            print("✅ MT5 balances updated successfully!")
            return True
        else:
        ...
        print(f"❌ Error updating MT5 balances: {str(e)}")
        return False
...
if __name__ == "__main__":
    success = asyncio.run(update_mt5_balances())
