...
```bash
curl -s "https://investment-portal-4.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://investment-portal-4.preview.emergentagent.com?skip_animation=true`
