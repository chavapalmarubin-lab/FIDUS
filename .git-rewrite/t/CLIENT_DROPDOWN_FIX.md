...
```bash
curl -s "https://fidus-workspace.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-workspace.preview.emergentagent.com?skip_animation=true`
