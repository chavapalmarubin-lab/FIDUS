...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://trading-platform-110.preview.emergentagent.com
```
...
curl -X GET https://trading-platform-110.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://trading-platform-110.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://trading-platform-110.preview.emergentagent.com/api/system/health/all
```
