...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://oauth-debugger.preview.emergentagent.com
```
...
curl -X GET https://oauth-debugger.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://oauth-debugger.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://oauth-debugger.preview.emergentagent.com/api/system/health/all
```
