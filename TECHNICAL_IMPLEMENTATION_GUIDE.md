...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://bridge-guardian.preview.emergentagent.com
```
...
curl -X GET https://bridge-guardian.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://bridge-guardian.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://bridge-guardian.preview.emergentagent.com/api/system/health/all
```
