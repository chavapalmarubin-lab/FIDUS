...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://prospects-portal.preview.emergentagent.com
```
...
curl -X GET https://prospects-portal.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://prospects-portal.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://prospects-portal.preview.emergentagent.com/api/system/health/all
```
