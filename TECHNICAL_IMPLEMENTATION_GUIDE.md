...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://allocation-hub-1.preview.emergentagent.com
```
...
curl -X GET https://allocation-hub-1.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://allocation-hub-1.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://allocation-hub-1.preview.emergentagent.com/api/system/health/all
```
