...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://apiview.preview.emergentagent.com
```
...
curl -X GET https://apiview.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://apiview.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://apiview.preview.emergentagent.com/api/system/health/all
```
