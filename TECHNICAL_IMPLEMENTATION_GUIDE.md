...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://risk-engine-v2.preview.emergentagent.com
```
...
curl -X GET https://risk-engine-v2.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://risk-engine-v2.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://risk-engine-v2.preview.emergentagent.com/api/system/health/all
```
