...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://trader-hub-27.preview.emergentagent.com
```
...
curl -X GET https://trader-hub-27.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://trader-hub-27.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://trader-hub-27.preview.emergentagent.com/api/system/health/all
```
