...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://multi-tenant-hub-32.preview.emergentagent.com
```
...
curl -X GET https://multi-tenant-hub-32.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://multi-tenant-hub-32.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://multi-tenant-hub-32.preview.emergentagent.com/api/system/health/all
```
