...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://referral-tracker-9.preview.emergentagent.com
```
...
curl -X GET https://referral-tracker-9.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://referral-tracker-9.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://referral-tracker-9.preview.emergentagent.com/api/system/health/all
```
