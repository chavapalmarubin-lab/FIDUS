...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://hull-risk-preview.preview.emergentagent.com
```
...
curl -X GET https://hull-risk-preview.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://hull-risk-preview.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://hull-risk-preview.preview.emergentagent.com/api/system/health/all
```
