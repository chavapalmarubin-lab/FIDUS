...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://truth-fincore.preview.emergentagent.com
```
...
curl -X GET https://truth-fincore.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://truth-fincore.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://truth-fincore.preview.emergentagent.com/api/system/health/all
```
