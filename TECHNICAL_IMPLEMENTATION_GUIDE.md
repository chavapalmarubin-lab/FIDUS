...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://alloc-refresh.preview.emergentagent.com
```
...
curl -X GET https://alloc-refresh.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://alloc-refresh.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://alloc-refresh.preview.emergentagent.com/api/system/health/all
```
