...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://financeflow-89.preview.emergentagent.com
```
...
curl -X GET https://financeflow-89.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://financeflow-89.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://financeflow-89.preview.emergentagent.com/api/system/health/all
```
