...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://truepnl-tracker.preview.emergentagent.com
```
...
curl -X GET https://truepnl-tracker.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://truepnl-tracker.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://truepnl-tracker.preview.emergentagent.com/api/system/health/all
```
