...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://finance-calc-hub-1.preview.emergentagent.com
```
...
curl -X GET https://finance-calc-hub-1.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://finance-calc-hub-1.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://finance-calc-hub-1.preview.emergentagent.com/api/system/health/all
```
