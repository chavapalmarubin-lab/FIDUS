...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://trader-insights-10.preview.emergentagent.com
```
...
curl -X GET https://trader-insights-10.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://trader-insights-10.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://trader-insights-10.preview.emergentagent.com/api/system/health/all
```
