...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fidus-risk-deep.preview.emergentagent.com
```
...
curl -X GET https://fidus-risk-deep.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fidus-risk-deep.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fidus-risk-deep.preview.emergentagent.com/api/system/health/all
```
