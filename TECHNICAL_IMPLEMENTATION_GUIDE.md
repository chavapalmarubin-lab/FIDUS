...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://analytics-hub-248.preview.emergentagent.com
```
...
curl -X GET https://analytics-hub-248.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://analytics-hub-248.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://analytics-hub-248.preview.emergentagent.com/api/system/health/all
```
