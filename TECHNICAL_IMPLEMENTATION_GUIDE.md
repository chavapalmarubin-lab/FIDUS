...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://viking-trade-dash.preview.emergentagent.com
```
...
curl -X GET https://viking-trade-dash.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://viking-trade-dash.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://viking-trade-dash.preview.emergentagent.com/api/system/health/all
```
