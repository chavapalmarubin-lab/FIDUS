...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://quant-viking.preview.emergentagent.com
```
...
curl -X GET https://quant-viking.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://quant-viking.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://quant-viking.preview.emergentagent.com/api/system/health/all
```
