...
curl -X GET https://account-filter-fix.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://account-filter-fix.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://account-filter-fix.preview.emergentagent.com/api/system/health/all
```
