...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fiddash.preview.emergentagent.com
```
...
curl -X GET https://fiddash.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fiddash.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fiddash.preview.emergentagent.com/api/system/health/all
```
