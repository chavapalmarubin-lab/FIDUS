...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://equity-peak-tracker.preview.emergentagent.com
```
...
curl -X GET https://equity-peak-tracker.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://equity-peak-tracker.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://equity-peak-tracker.preview.emergentagent.com/api/system/health/all
```
