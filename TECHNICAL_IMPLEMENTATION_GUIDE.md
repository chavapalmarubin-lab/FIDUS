...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fund-manager-assign.preview.emergentagent.com
```
...
curl -X GET https://fund-manager-assign.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fund-manager-assign.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fund-manager-assign.preview.emergentagent.com/api/system/health/all
```
