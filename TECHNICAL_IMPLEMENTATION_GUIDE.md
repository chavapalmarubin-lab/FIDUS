...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://financial-api-fix.preview.emergentagent.com
```
...
curl -X GET https://financial-api-fix.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://financial-api-fix.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://financial-api-fix.preview.emergentagent.com/api/system/health/all
```
