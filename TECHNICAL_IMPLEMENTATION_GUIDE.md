...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://securedash-5.preview.emergentagent.com
```
...
curl -X GET https://securedash-5.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://securedash-5.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://securedash-5.preview.emergentagent.com/api/system/health/all
```
