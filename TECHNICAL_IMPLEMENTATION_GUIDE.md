...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fidus-mt5-bridge.preview.emergentagent.com
```
...
curl -X GET https://fidus-mt5-bridge.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fidus-mt5-bridge.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fidus-mt5-bridge.preview.emergentagent.com/api/system/health/all
```
