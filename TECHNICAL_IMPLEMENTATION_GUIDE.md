...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://vkng-dashboard.preview.emergentagent.com
```
...
curl -X GET https://vkng-dashboard.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://vkng-dashboard.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://vkng-dashboard.preview.emergentagent.com/api/system/health/all
```
