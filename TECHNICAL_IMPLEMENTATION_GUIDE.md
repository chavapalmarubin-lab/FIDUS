...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://dashboard-unify.preview.emergentagent.com
```
...
curl -X GET https://dashboard-unify.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://dashboard-unify.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://dashboard-unify.preview.emergentagent.com/api/system/health/all
```
