...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://portfolio-metrics-3.preview.emergentagent.com
```
...
curl -X GET https://portfolio-metrics-3.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://portfolio-metrics-3.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://portfolio-metrics-3.preview.emergentagent.com/api/system/health/all
```
