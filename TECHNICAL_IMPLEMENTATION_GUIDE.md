...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://advisor-dash-1.preview.emergentagent.com
```
...
curl -X GET https://advisor-dash-1.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://advisor-dash-1.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://advisor-dash-1.preview.emergentagent.com/api/system/health/all
```
