...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://broker-connect-35.preview.emergentagent.com
```
...
curl -X GET https://broker-connect-35.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://broker-connect-35.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://broker-connect-35.preview.emergentagent.com/api/system/health/all
```
