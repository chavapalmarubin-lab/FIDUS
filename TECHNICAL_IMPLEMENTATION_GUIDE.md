...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://autobridge.preview.emergentagent.com
```
...
curl -X GET https://autobridge.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://autobridge.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://autobridge.preview.emergentagent.com/api/system/health/all
```
