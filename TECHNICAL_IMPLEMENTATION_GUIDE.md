...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://mt5-sync.preview.emergentagent.com
```
...
curl -X GET https://mt5-sync.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://mt5-sync.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://mt5-sync.preview.emergentagent.com/api/system/health/all
```
