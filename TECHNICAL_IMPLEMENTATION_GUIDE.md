...
curl -X GET https://ssot-finance.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://ssot-finance.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://ssot-finance.preview.emergentagent.com/api/system/health/all
```
