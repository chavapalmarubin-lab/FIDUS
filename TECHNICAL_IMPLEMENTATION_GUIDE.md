...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://transfer-classifier.preview.emergentagent.com
```
...
curl -X GET https://transfer-classifier.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://transfer-classifier.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://transfer-classifier.preview.emergentagent.com/api/system/health/all
```
