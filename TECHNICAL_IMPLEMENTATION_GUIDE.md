...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://data-consistency-4.preview.emergentagent.com
```
...
curl -X GET https://data-consistency-4.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://data-consistency-4.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://data-consistency-4.preview.emergentagent.com/api/system/health/all
```
