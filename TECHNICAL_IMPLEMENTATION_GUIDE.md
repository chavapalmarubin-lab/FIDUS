...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://token-rescue-2.preview.emergentagent.com
```
...
curl -X GET https://token-rescue-2.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://token-rescue-2.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://token-rescue-2.preview.emergentagent.com/api/system/health/all
```
