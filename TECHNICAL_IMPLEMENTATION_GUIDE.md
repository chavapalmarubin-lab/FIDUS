...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://lucrum-api-debug.preview.emergentagent.com
```
...
curl -X GET https://lucrum-api-debug.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://lucrum-api-debug.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://lucrum-api-debug.preview.emergentagent.com/api/system/health/all
```
