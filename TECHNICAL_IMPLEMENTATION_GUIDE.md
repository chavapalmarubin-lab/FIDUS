...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://prospect-portal.preview.emergentagent.com
```
...
curl -X GET https://prospect-portal.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://prospect-portal.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://prospect-portal.preview.emergentagent.com/api/system/health/all
```
