...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fidusrefs.preview.emergentagent.com
```
...
curl -X GET https://fidusrefs.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fidusrefs.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fidusrefs.preview.emergentagent.com/api/system/health/all
```
