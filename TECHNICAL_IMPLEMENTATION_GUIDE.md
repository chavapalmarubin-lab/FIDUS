...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://realtime-trader-4.preview.emergentagent.com
```
...
curl -X GET https://realtime-trader-4.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://realtime-trader-4.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://realtime-trader-4.preview.emergentagent.com/api/system/health/all
```
