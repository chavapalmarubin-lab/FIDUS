...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://cashflow-manager-35.preview.emergentagent.com
```
...
curl -X GET https://cashflow-manager-35.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://cashflow-manager-35.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://cashflow-manager-35.preview.emergentagent.com/api/system/health/all
```
