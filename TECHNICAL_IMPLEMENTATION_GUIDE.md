...
curl -X GET https://fintech-dashboard-60.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fintech-dashboard-60.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fintech-dashboard-60.preview.emergentagent.com/api/system/health/all
```
