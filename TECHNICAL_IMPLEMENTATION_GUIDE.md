...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fidusbridge.preview.emergentagent.com
```
...
curl -X GET https://fidusbridge.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fidusbridge.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fidusbridge.preview.emergentagent.com/api/system/health/all
```
