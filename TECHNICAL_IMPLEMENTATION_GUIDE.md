...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fintech-monitor-2.preview.emergentagent.com
```
...
curl -X GET https://fintech-monitor-2.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fintech-monitor-2.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fintech-monitor-2.preview.emergentagent.com/api/system/health/all
```
