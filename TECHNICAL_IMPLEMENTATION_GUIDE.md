...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://alloc-wizard.preview.emergentagent.com
```
...
curl -X GET https://alloc-wizard.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://alloc-wizard.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://alloc-wizard.preview.emergentagent.com/api/system/health/all
```
