...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://trade-guardian-11.preview.emergentagent.com
```
...
curl -X GET https://trade-guardian-11.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://trade-guardian-11.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://trade-guardian-11.preview.emergentagent.com/api/system/health/all
```
