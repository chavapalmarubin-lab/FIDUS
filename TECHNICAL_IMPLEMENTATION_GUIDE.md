...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://fidusmt5-sync.preview.emergentagent.com
```
...
curl -X GET https://fidusmt5-sync.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://fidusmt5-sync.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://fidusmt5-sync.preview.emergentagent.com/api/system/health/all
```
