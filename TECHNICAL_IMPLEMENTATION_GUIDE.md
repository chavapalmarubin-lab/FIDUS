...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://oauth-reforge.preview.emergentagent.com
```
...
curl -X GET https://oauth-reforge.preview.emergentagent.com/api/system/health/all \
...
curl -X POST https://oauth-reforge.preview.emergentagent.com/api/actions/sync-mt5 \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
curl https://oauth-reforge.preview.emergentagent.com/api/system/health/all
```
