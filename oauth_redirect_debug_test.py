...
def check_environment_configuration():
    ...
    backend_env_config = {
        ...
        'GOOGLE_OAUTH_REDIRECT_URI': 'https://fidus-finance-api.preview.emergentagent.com/admin/google-callback',
    ...
    frontend_env_config = {
        'REACT_APP_BACKEND_URL': 'https://fidus-finance-api.preview.emergentagent.com',
