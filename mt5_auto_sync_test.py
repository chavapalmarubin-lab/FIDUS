...
class MT5AutoSyncTestSuite:
    ...
    async def test_mt5_sync_dashboard(self) -> Dict[str, Any]:
        ...
        validation_results = []
        endpoint_url = f"{self.backend_url}/api/mt5/sync-dashboard"
    ...
    async def test_force_sync_account_886528(self) -> Dict[str, Any]:
        ...
        validation_results = []
        endpoint_url = f"{self.backend_url}/api/mt5/force-sync/886528"
    ...
    async def test_start_background_sync(self) -> Dict[str, Any]:
        ...
        validation_results = []
        endpoint_url = f"{self.backend_url}/api/mt5/start-background-sync"
    ...
    async def test_stop_background_sync(self) -> Dict[str, Any]:
        ...
        validation_results = []
        endpoint_url = f"{self.backend_url}/api/mt5/stop-background-sync"
