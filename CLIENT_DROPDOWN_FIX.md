...
```bash
curl -s "https://finance-calc-hub-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://finance-calc-hub-1.preview.emergentagent.com?skip_animation=true`
