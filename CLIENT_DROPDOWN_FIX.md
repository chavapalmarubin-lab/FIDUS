...
```bash
curl -s "https://fidus-autofix.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-autofix.preview.emergentagent.com?skip_animation=true`
