...
```bash
curl -s "https://fintech-monitor-2.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fintech-monitor-2.preview.emergentagent.com?skip_animation=true`
