...
```bash
curl -s "https://finance-dashboard-158.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://finance-dashboard-158.preview.emergentagent.com?skip_animation=true`
