...
```bash
curl -s "https://invest-platform-19.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://invest-platform-19.preview.emergentagent.com?skip_animation=true`
