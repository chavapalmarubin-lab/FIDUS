...
```bash
curl -s "https://fidus-restore.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-restore.preview.emergentagent.com?skip_animation=true`
