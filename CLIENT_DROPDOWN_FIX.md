...
```bash
curl -s "https://invest-portal-22.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://invest-portal-22.preview.emergentagent.com?skip_animation=true`
