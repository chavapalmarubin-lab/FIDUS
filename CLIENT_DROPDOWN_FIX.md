...
```bash
curl -s "https://lucrum-api-debug.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://lucrum-api-debug.preview.emergentagent.com?skip_animation=true`
