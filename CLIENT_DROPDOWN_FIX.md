...
```bash
curl -s "https://ssot-finance.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://ssot-finance.preview.emergentagent.com?skip_animation=true`
