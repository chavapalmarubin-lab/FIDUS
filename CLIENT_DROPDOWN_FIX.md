...
```bash
curl -s "https://fidusrefs.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidusrefs.preview.emergentagent.com?skip_animation=true`
