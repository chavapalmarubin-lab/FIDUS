...
```bash
curl -s "https://mt5-portal.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://mt5-portal.preview.emergentagent.com?skip_animation=true`
