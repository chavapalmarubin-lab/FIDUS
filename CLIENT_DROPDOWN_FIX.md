...
```bash
curl -s "https://data-consistency-4.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://data-consistency-4.preview.emergentagent.com?skip_animation=true`
