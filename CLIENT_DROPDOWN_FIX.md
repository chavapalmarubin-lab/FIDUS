...
```bash
curl -s "https://trader-insights-10.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://trader-insights-10.preview.emergentagent.com?skip_animation=true`
