...
```bash
curl -s "https://fidus-monitor.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-monitor.preview.emergentagent.com?skip_animation=true`
