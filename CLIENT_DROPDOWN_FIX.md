...
```bash
curl -s "https://wealth-portal-17.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://wealth-portal-17.preview.emergentagent.com?skip_animation=true`
