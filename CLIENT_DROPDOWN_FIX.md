...
```bash
curl -s "https://fidus-finance-3.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-finance-3.preview.emergentagent.com?skip_animation=true`
