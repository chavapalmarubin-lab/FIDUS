...
```bash
curl -s "https://trading-platform-110.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://trading-platform-110.preview.emergentagent.com?skip_animation=true`
