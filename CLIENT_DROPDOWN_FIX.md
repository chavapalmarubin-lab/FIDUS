...
```bash
curl -s "https://fund-performance.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fund-performance.preview.emergentagent.com?skip_animation=true`
