...
```bash
curl -s "https://hull-risk-preview.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://hull-risk-preview.preview.emergentagent.com?skip_animation=true`
