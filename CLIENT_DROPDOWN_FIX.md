...
```bash
curl -s "https://oauth-debugger.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://oauth-debugger.preview.emergentagent.com?skip_animation=true`
