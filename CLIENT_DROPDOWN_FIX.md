...
```bash
curl -s "https://trader-hub-27.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://trader-hub-27.preview.emergentagent.com?skip_animation=true`
