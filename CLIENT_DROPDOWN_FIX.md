...
```bash
curl -s "https://fidusbridge.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidusbridge.preview.emergentagent.com?skip_animation=true`
