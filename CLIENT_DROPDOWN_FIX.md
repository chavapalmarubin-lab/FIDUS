...
```bash
curl -s "https://fidus-api-bridge.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-api-bridge.preview.emergentagent.com?skip_animation=true`
