...
```bash
curl -s "https://cashflow-manager-35.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://cashflow-manager-35.preview.emergentagent.com?skip_animation=true`
