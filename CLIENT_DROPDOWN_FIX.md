...
```bash
curl -s "https://fidus-mt5-bridge.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-mt5-bridge.preview.emergentagent.com?skip_animation=true`
