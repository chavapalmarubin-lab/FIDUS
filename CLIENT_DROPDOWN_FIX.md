...
```bash
curl -s "https://trader-analytics-hub-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://trader-analytics-hub-1.preview.emergentagent.com?skip_animation=true`
