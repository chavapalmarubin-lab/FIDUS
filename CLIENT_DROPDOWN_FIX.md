...
```bash
curl -s "https://fidus-risk-deep.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-risk-deep.preview.emergentagent.com?skip_animation=true`
