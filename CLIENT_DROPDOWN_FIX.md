...
```bash
curl -s "https://mockdb-cleanup.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://mockdb-cleanup.preview.emergentagent.com?skip_animation=true`
