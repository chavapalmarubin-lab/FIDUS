...
```bash
curl -s "https://tradeconnect-14.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://tradeconnect-14.preview.emergentagent.com?skip_animation=true`
