...
```bash
curl -s "https://autobridge.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://autobridge.preview.emergentagent.com?skip_animation=true`
