...
```bash
curl -s "https://fund-manager-assign.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fund-manager-assign.preview.emergentagent.com?skip_animation=true`
