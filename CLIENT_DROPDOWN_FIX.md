...
```bash
curl -s "https://token-rescue-2.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://token-rescue-2.preview.emergentagent.com?skip_animation=true`
