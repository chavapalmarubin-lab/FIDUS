...
```bash
curl -s "https://referral-rescue.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://referral-rescue.preview.emergentagent.com?skip_animation=true`
