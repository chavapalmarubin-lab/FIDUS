...
```bash
curl -s "https://quant-viking.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://quant-viking.preview.emergentagent.com?skip_animation=true`
