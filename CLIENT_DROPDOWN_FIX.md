...
```bash
curl -s "https://investment-metrics.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://investment-metrics.preview.emergentagent.com?skip_animation=true`
