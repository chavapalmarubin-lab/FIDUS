...
```bash
curl -s "https://truth-fincore.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://truth-fincore.preview.emergentagent.com?skip_animation=true`
