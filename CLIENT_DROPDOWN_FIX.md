...
```bash
curl -s "https://financesyncpro.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://financesyncpro.preview.emergentagent.com?skip_animation=true`
