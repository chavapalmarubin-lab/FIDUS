...
```bash
curl -s "https://vps-bridge-fix.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://vps-bridge-fix.preview.emergentagent.com?skip_animation=true`
