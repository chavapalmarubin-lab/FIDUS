...
```bash
curl -s "https://fidus-agents.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-agents.preview.emergentagent.com?skip_animation=true`
