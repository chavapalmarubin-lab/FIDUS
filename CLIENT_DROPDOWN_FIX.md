...
```bash
curl -s "https://portfolio-metrics-3.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://portfolio-metrics-3.preview.emergentagent.com?skip_animation=true`
