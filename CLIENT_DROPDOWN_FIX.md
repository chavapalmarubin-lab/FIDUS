...
```bash
curl -s "https://investor-dash-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://investor-dash-1.preview.emergentagent.com?skip_animation=true`
