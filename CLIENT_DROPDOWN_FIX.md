...
```bash
curl -s "https://auth-troubleshoot-14.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://auth-troubleshoot-14.preview.emergentagent.com?skip_animation=true`
