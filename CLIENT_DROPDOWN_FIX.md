...
```bash
curl -s "https://data-integrity-13.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://data-integrity-13.preview.emergentagent.com?skip_animation=true`
