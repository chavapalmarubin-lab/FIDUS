...
```bash
curl -s "https://alloc-refresh.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://alloc-refresh.preview.emergentagent.com?skip_animation=true`
