...
```bash
curl -s "https://invest-tracker-146.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://invest-tracker-146.preview.emergentagent.com?skip_animation=true`
