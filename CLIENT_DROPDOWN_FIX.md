...
```bash
curl -s "https://finance-portal-60.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://finance-portal-60.preview.emergentagent.com?skip_animation=true`
