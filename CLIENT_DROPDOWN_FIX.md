...
```bash
curl -s "https://auth-flow-debug-2.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://auth-flow-debug-2.preview.emergentagent.com?skip_animation=true`
