...
```bash
curl -s "https://truepnl-tracker.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://truepnl-tracker.preview.emergentagent.com?skip_animation=true`
