...
```bash
curl -s "https://account-filter-fix.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://account-filter-fix.preview.emergentagent.com?skip_animation=true`
