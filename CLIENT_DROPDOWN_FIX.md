...
```bash
curl -s "https://fidus-finance-api.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-finance-api.preview.emergentagent.com?skip_animation=true`
