...
```bash
curl -s "https://fidus-invest-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-invest-1.preview.emergentagent.com?skip_animation=true`
