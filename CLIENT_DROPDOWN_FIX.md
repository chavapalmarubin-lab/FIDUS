...
```bash
curl -s "https://fidus-fix.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-fix.preview.emergentagent.com?skip_animation=true`
