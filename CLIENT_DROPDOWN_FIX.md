...
```bash
curl -s "https://viking-analytics.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://viking-analytics.preview.emergentagent.com?skip_animation=true`
