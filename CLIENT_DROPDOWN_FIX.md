...
```bash
curl -s "https://mt5-deploy-debug.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://mt5-deploy-debug.preview.emergentagent.com?skip_animation=true`
