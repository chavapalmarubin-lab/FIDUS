...
```bash
curl -s "https://invest-manager-9.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://invest-manager-9.preview.emergentagent.com?skip_animation=true`
