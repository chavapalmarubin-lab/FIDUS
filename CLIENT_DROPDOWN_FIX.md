...
```bash
curl -s "https://transfer-classifier.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://transfer-classifier.preview.emergentagent.com?skip_animation=true`
