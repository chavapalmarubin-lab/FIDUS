...
```bash
curl -s "https://oauth-reforge.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://oauth-reforge.preview.emergentagent.com?skip_animation=true`
