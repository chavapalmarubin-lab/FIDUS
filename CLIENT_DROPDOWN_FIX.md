...
```bash
curl -s "https://oauth-flow-debug.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://oauth-flow-debug.preview.emergentagent.com?skip_animation=true`
