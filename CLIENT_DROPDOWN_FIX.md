...
```bash
curl -s "https://securedash-5.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://securedash-5.preview.emergentagent.com?skip_animation=true`
