...
```bash
curl -s "https://fidus-google-sync.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-google-sync.preview.emergentagent.com?skip_animation=true`
