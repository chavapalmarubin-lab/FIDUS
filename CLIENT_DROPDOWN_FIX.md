...
```bash
curl -s "https://trade-guardian-11.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://trade-guardian-11.preview.emergentagent.com?skip_animation=true`
