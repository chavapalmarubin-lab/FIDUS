...
```bash
curl -s "https://crm-workspace-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://crm-workspace-1.preview.emergentagent.com?skip_animation=true`
