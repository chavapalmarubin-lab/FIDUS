...
```bash
curl -s "https://apiview.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://apiview.preview.emergentagent.com?skip_animation=true`
