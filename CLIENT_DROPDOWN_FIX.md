...
```bash
curl -s "https://prospect-portal.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://prospect-portal.preview.emergentagent.com?skip_animation=true`
