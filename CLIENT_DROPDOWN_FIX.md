...
```bash
curl -s "https://broker-connect-35.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://broker-connect-35.preview.emergentagent.com?skip_animation=true`
