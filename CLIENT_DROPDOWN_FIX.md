...
```bash
curl -s "https://aml-kyc-portal.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://aml-kyc-portal.preview.emergentagent.com?skip_animation=true`
