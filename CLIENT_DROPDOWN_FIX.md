...
```bash
curl -s "https://investsim-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://investsim-1.preview.emergentagent.com?skip_animation=true`
