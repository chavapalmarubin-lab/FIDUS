...
```bash
curl -s "https://viking-trade-dash.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://viking-trade-dash.preview.emergentagent.com?skip_animation=true`
