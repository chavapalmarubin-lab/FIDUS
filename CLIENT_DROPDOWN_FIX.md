...
```bash
curl -s "https://bridge-guardian.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://bridge-guardian.preview.emergentagent.com?skip_animation=true`
