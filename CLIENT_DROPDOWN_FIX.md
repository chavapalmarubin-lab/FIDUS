...
```bash
curl -s "https://fidusmt5-sync.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidusmt5-sync.preview.emergentagent.com?skip_animation=true`
