...
```bash
curl -s "https://investment-portal-2.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://investment-portal-2.preview.emergentagent.com?skip_animation=true`
