...
```bash
curl -s "https://referral-tracker-9.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://referral-tracker-9.preview.emergentagent.com?skip_animation=true`
