...
```bash
curl -s "https://financial-api-fix.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://financial-api-fix.preview.emergentagent.com?skip_animation=true`
