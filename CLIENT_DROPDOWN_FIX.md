...
```bash
curl -s "https://multi-tenant-hub-32.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://multi-tenant-hub-32.preview.emergentagent.com?skip_animation=true`
