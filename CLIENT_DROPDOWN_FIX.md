...
```bash
curl -s "https://fidus-pnl-fix.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-pnl-fix.preview.emergentagent.com?skip_animation=true`
