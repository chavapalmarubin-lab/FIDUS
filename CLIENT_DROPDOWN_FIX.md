...
```bash
curl -s "https://fidus-invest.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-invest.preview.emergentagent.com?skip_animation=true`
