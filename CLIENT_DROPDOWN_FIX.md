...
```bash
curl -s "https://fund-tracker-11.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fund-tracker-11.preview.emergentagent.com?skip_animation=true`
