...
```bash
curl -s "https://financeflow-89.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://financeflow-89.preview.emergentagent.com?skip_animation=true`
