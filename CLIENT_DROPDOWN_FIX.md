...
```bash
curl -s "https://k8s-to-render.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://k8s-to-render.preview.emergentagent.com?skip_animation=true`
