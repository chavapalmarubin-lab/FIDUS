...
```bash
curl -s "https://fidus-integration.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-integration.preview.emergentagent.com?skip_animation=true`
