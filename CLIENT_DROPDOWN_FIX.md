...
```bash
curl -s "https://analytics-hub-248.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://analytics-hub-248.preview.emergentagent.com?skip_animation=true`
