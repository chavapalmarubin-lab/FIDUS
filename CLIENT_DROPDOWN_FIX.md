...
```bash
curl -s "https://fidus-techdocs.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-techdocs.preview.emergentagent.com?skip_animation=true`
