...
```bash
curl -s "https://fidus-admin.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-admin.preview.emergentagent.com?skip_animation=true`
