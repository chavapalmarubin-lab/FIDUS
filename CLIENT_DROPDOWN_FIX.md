...
```bash
curl -s "https://fidus-trading.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-trading.preview.emergentagent.com?skip_animation=true`
