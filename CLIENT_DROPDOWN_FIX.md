...
```bash
curl -s "https://risk-engine-v2.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://risk-engine-v2.preview.emergentagent.com?skip_animation=true`
