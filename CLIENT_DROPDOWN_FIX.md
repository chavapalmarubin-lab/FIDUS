...
```bash
curl -s "https://dashboard-unify.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://dashboard-unify.preview.emergentagent.com?skip_animation=true`
