...
```bash
curl -s "https://realtime-trader-4.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://realtime-trader-4.preview.emergentagent.com?skip_animation=true`
