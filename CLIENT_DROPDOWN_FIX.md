...
```bash
curl -s "https://referral-portal-5.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://referral-portal-5.preview.emergentagent.com?skip_animation=true`
