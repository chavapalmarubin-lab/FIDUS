...
```bash
curl -s "https://fintech-dashboard-33.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fintech-dashboard-33.preview.emergentagent.com?skip_animation=true`
