...
```bash
curl -s "https://fiddash.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fiddash.preview.emergentagent.com?skip_animation=true`
