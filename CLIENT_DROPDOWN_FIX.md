...
```bash
curl -s "https://tradingteam-setup.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://tradingteam-setup.preview.emergentagent.com?skip_animation=true`
