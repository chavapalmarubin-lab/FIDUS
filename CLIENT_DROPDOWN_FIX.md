...
```bash
curl -s "https://alloc-wizard.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://alloc-wizard.preview.emergentagent.com?skip_animation=true`
