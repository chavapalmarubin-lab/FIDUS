...
```bash
curl -s "https://fidus-trade.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidus-trade.preview.emergentagent.com?skip_animation=true`
