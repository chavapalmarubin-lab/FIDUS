...
```bash
curl -s "https://equity-peak-tracker.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://equity-peak-tracker.preview.emergentagent.com?skip_animation=true`
