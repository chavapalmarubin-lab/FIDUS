...
```bash
curl -s "https://investsync-1.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://investsync-1.preview.emergentagent.com?skip_animation=true`
