...
```bash
curl -s "https://fidussign.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://fidussign.preview.emergentagent.com?skip_animation=true`
