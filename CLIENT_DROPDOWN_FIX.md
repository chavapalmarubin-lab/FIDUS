...
```bash
curl -s "https://vkng-dashboard.preview.emergentagent.com/api/clients/ready-for-investment"
```
...
1. **Login**: Go to `https://vkng-dashboard.preview.emergentagent.com?skip_animation=true`
