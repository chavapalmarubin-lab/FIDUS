...
Portal URL: https://advisor-dash-1.preview.emergentagent.com/referral-agent/login
Production API: https://advisor-dash-1.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://advisor-dash-1.preview.emergentagent.com/referral-agent/login")
