...
Portal URL: https://lucrum-api-debug.preview.emergentagent.com/referral-agent/login
Production API: https://lucrum-api-debug.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://lucrum-api-debug.preview.emergentagent.com/referral-agent/login")
