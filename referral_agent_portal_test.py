...
Portal URL: https://ssot-finance.preview.emergentagent.com/referral-agent/login
Production API: https://ssot-finance.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://ssot-finance.preview.emergentagent.com/referral-agent/login")
