...
Portal URL: https://analytics-hub-248.preview.emergentagent.com/referral-agent/login
Production API: https://analytics-hub-248.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    def __init__(self):
        self.base_url = "https://analytics-hub-248.preview.emergentagent.com/api"
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://analytics-hub-248.preview.emergentagent.com/referral-agent/login")
