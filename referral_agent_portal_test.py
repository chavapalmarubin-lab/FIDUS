...
Portal URL: https://data-integrity-13.preview.emergentagent.com/referral-agent/login
Production API: https://data-integrity-13.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://data-integrity-13.preview.emergentagent.com/referral-agent/login")
