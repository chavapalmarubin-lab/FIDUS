...
Portal URL: https://multi-tenant-hub-32.preview.emergentagent.com/referral-agent/login
Production API: https://multi-tenant-hub-32.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    def __init__(self):
        self.base_url = "https://multi-tenant-hub-32.preview.emergentagent.com/api"
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://multi-tenant-hub-32.preview.emergentagent.com/referral-agent/login")
