...
Portal URL: https://referral-portal-5.preview.emergentagent.com/referral-agent/login
Production API: https://referral-portal-5.preview.emergentagent.com/api
...
class ReferralAgentPortalTester:
    ...
    def test_salvador_login_dashboard(self) -> bool:
        ...
        try:
            ...
            self.salvador_token = login_data['token']
    ...
    def run_all_tests(self) -> bool:
        ...
        print("=" * 80)
        print(f"Portal URL: https://referral-portal-5.preview.emergentagent.com/referral-agent/login")
