...
```
https://trader-analytics-hub-1.preview.emergentagent.com/api/...
```
...
- Frontend `.env` file: `REACT_APP_BACKEND_URL=https://trader-analytics-hub-1.preview.emergentagent.com`
